...
/**
 * DesignImageUpload - Image upload for img2img mode
 * Based on FloorPlanUpload pattern with base64 conversion
 */
const DesignImageUpload = ({ onImageSelect, selectedFile, previewUrl }) => {
  ...
  return (
    <div className="design-image-upload">
        ...
        {!selectedFile ? (
          <div className="upload-placeholder">
            ...
            <p className="text-muted mb-2">
              Drag and drop a photo of your room or exterior
            </p>
...
export default DesignImageUpload;
